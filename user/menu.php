...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["addCartBtn"])) {
    ...
    try {
        ...
        $sql = "INSERT INTO order_cart (item_name, price, quantity, order_status)
                VALUES (:item_name, :price, :quantity, 'Pending')";
    ...
    <div class="modal fade" id="quantityGiniling" tabindex="-1" role="dialog" aria-labelledby="quantityModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content custom-modal">
                ...
                <div class="modal-body">
                    <form method="post" action="menu.php" class="modal-form">
                        <input type="hidden" name="item_name" value="Giniling" />
                        <input type="hidden" name="price" value="80.00" />
                ...
                <div class="modal-body">
                    <form method="post" action="menu.php" class="modal-form">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <input type="number" name="quantity" id="quantityInputIcedTea" value="1" min="1" class="mx-2" class="custom-input" readonly />
            ...
            <div class="modal-content custom-modal">
                ...
                <div class="modal-body">
                    <form method="post" action="menu.php" class="modal-form">
                        ...
                        <h3 class="font-kohsan text-center"><b>Quantity for Coca Cola:</b></h3>
                        <div class="d-flex justify-content-center align-items-center">
